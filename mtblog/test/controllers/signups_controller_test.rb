...
class SignupsControllerTest < ActionController::TestCase
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post :create, signup: { Email: @signup.Email, FisrtName: @signup.FisrtName, LastName: @signup.LastName }
    end
  ...
  test "should update signup" do
    patch :update, id: @signup, signup: { Email: @signup.Email, FisrtName: @signup.FisrtName, LastName: @signup.LastName }
    assert_redirected_to signup_path(assigns(:signup))
  end
